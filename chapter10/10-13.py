...
def greet_user():
    ...
    if user_dict:
        ...
        print(f"Hope you're been playing some {user_dict['game']}.")
        print(f"Have you see a {user_dict['animal']} recently?")
    else:
        user_dict = get_new_user_info(path)
        msg = f"We'll member you when you return, {user_dict['username']}!"
greet_user()
